...
export const reviews = [
  ...
  {
    name: "마법사 육성 + 파밍",
    body: "육성하면서 아데나까지 그대로 쌓여 있어서 놀랐습니다. 진행 과정도 투명하게 공유해주셔서 믿음이 갔어요.",
    rating: 5,
  },
];
...
export const faqs = [
  ...
  {
    q: "계정 보안은 어떻게 보장되나요?",
    a: "접속 정보는 담당 관리자 1인만 접근하며 보안 수칙을 엄격히 준수합니다. 작업 완료 즉시 비밀번호 변경을 안내드립니다.",
  },
  {
    q: "비용은 어떻게 책정되나요?",
  ...
  {
    q: "중도 취소가 가능한가요?",
    a: "가능합니다. 진행된 구간만큼 정산 후 잔여 금액을 환불해드립니다. 자세한 기준은 상담 시 안내드립니다.",
  },
];
